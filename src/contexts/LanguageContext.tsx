...
const translations = {
  sv: {
    ...
    pleaseEnterSchoolInfo: 'Vänligen ange skola och antal lärare/elever.',
    school: 'Skola',
    schoolPlaceholder: 'Skolnamn',
    enterSchoolName: 'Ange namn på skola',
    numberOfTeachers: 'Antal ansvariga lärare',
    numberOfStudents: 'Antal elever',
    selectValidNumber: 'Välj ett giltigt antal',
    company: 'Företag',
    ...
    termsServiceProducts: 'Rör aldrig artiklar i produktion.',
    ...
    generalVisit: 'Besök',
    generalVisitDescription: 'Möten, intervjuer eller övriga besök',
    regularVisit: 'Besök',
    regularVisitDescription: 'Möten, intervjuer eller övriga besök',
    serviceVisit: 'Service',
    ...
    host: 'Värd',
    visitType: 'Besökstyp',
    regularVisitText: 'Allmänt besök',
  ...
  en: {
    ...
    pleaseEnterSchoolInfo: 'Please enter school and number of teachers/students.',
    school: 'School',
    schoolPlaceholder: 'School name',
    enterSchoolName: 'Enter school name',
    numberOfTeachers: 'Number of responsible teachers',
    numberOfStudents: 'Number of students',
    selectValidNumber: 'Select a valid number',
    company: 'Company',
    ...
    termsRegularProducts: 'Never touch machine equipment, materials, or produced parts.',
    termsServiceProducts: 'Never touch any products.',
    termsEmergency: 'In case of an emergency signal, leave the building and proceed to the assembly point behind the factory at the edge of the parking lot.',
  ...
  de: {
    ...
    pleaseEnterSchoolInfo: 'Bitte geben Sie Schule und Anzahl der Lehrer/Schüler ein.',
    school: 'Schule',
    schoolPlaceholder: 'Schulname',
    enterSchoolName: 'Schulname eingeben',
    numberOfTeachers: 'Anzahl verantwortlicher Lehrer',
    numberOfStudents: 'Anzahl der Schüler',
    selectValidNumber: 'Gültige Anzahl wählen',
    company: 'Unternehmen',
