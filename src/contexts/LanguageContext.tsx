...
const translations = {
  sv: {
    ...
    // Admin Dashboard
    adminDashboard: 'FMAB Kontrollpanel',
    controlPanel: 'Kontrollpanel',
    currentVisitors: 'Nuvarande besökare',
    historyTab: 'Historik',
    visitorHistory: 'Besökarhistorik',
    schoolVisitHistory: 'Skolbesökshistorik',
    activeVisitors: 'Aktiva besökare',
    loading: 'Laddar...',
    // Login
    ...
    accessDenied: 'Åtkomst nekad. Du har inte tillgång till detta system.',
    loginError: 'Ett fel uppstod vid inloggning. Försök igen.',
    loadingHistory: 'Laddar historik...',
    nameColumn: 'Namn',
    companyColumn: 'Företag',
    visitingColumn: 'Besöker',
    checkInTimeColumn: 'Incheckningstid',
    checkOutTimeColumn: 'Utcheckningstid',
    typeColumn: 'Typ',
    actionsColumn: 'Åtgärder',
    checkOutAction: 'Checka ut',
    checkOutVisitorDialog: 'Checka ut besökare',
    checkingOutLabel: 'Checkar ut:',
    checkOutDateTimeLabel: 'Utcheckningsdatum och tid',
    confirmCheckOutAction: 'Bekräfta utcheckning',
    visitorCheckedOutToast: 'Besökare utcheckad',
    hasBeenCheckedOutMessage: 'har checkats ut.',
    failedToCheckOutVisitorError: 'Kunde inte checka ut besökaren. Försök igen.',
    noActiveVisitorsMessage: 'Inga besökare är för närvarande incheckade.',
    searchNamePlaceholder: 'Sök namn...',
    searchCompanyPlaceholder: 'Sök företag...',
    dateFromLabel: 'Från datum',
    dateToLabel: 'Till datum',
    clearFiltersButton: 'Rensa filter',
    showingText: 'Visar',
    ofText: 'av',
    resultsText: 'resultat',
    noMatchingVisitorsMessage: 'Inga matchande besökare hittades.',
    noVisitorHistoryMessage: 'Ingen besökarhistorik tillgänglig.',
    regularType: 'Vanligt',
    serviceType: 'Service',
    schoolType: 'Skola',
    ...
    visitTypeFilter: 'Besökstyp',
    allVisitsFilter: 'Alla besök',
    regularVisitsFilter: 'Vanliga besök',
    serviceVisitsFilter: 'Service besök',
    schoolVisitsFilter: 'Skolbesök',
    schoolNameColumn: 'Skolnamn',
    teacherNameColumn: 'Lärarnamn',
    studentCountColumn: 'Antal elever',
    noSchoolVisitsMessage: 'Inga skolbesök tillgängliga.'
  },
  en: {
    welcome: 'Welcome!',
